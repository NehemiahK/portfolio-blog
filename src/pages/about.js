...
const work = [
  {
    ...
    bullets: [
      "Created UI components in React, and API’s in PHP/Kohana as part of the Hometalk TV team.",
  ...
  },
  {
    ...
    bullets: [
      "Created better QA tooling and  work efficiency using Selenium scripts to mimic complex and manual testing procedures.",
...
const volunteerWork = [
  {
    ...
    bullets: [
      "Implemented technophobe friendly user interfaces in React for administrative and user facing pages on the Points of Contact website.",
...
const education = [
  {
    title:
      "Israel Tech Challenge — Full-Stack Web Development Bootcamp, 2017-2018",
    bullets: [
      "5-month bootcamp focused on web development, using frontend languages and frameworks. ",
  ...
  {
    title:
      "Bar Ilan University — B.A. in Communications and Information Science, 2014-2017",
    bullets: [
      "Courses included: Client Side Development, Database Management, SEO, and Research Methods. ",
    ],
  },
]
    ...
    <Layout background={"#8fafa1"}>
      ...
      <div className="about">
        ...
        <div className="tagline">
          Fullstack Web Developer with experience in React, PHP, NodeJs. I most
          recently worked at Hometalk, a web based internet company, and I’m
...
const WorkSection = props => {
  return (
    <>
      ...
      <ul>
        {props.bullets.map((bullet, indx) => (
          <li key={indx}>{bullet}</li>
        ))}
      </ul>
    </>
  )
